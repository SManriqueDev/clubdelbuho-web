  ...
  <div>
    <div class="mb-3">
      <inertia-link class="flex items-center group py-3" :href="route('dashboard')">
        <feather-icon icon="HomeIcon" class="w-4 h-4 mr-2" :svgClasses="isUrl('') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
    ...
    <div class="mb-3">
      <inertia-link class="flex items-center group py-3" :href="route('organizations')">
        ...
        <div :class="isUrl('organizations') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Organizaciones</div>
      </inertia-link>
    </div>
    <div class="mb-3">
